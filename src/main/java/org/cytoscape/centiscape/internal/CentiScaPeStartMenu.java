...
public class CentiScaPeStartMenu extends javax.swing.JPanel implements CytoPanelComponent {
    ...
    private void initComponents() {
        ...
        InformationQuantityCheckBox = new javax.swing.JCheckBox();
        InformationQuantityHelpButton = new javax.swing.JButton();
        ...
        SingleNetCheckBox = new javax.swing.JCheckBox();
        MultipleNetCheckBox = new javax.swing.JCheckBox();
        jLabel10 = new javax.swing.JLabel();
        AttributeCombo = new javax.swing.JComboBox();
        NodeMultButton = new javax.swing.JButton();
        ...
        InformationQuantityCheckBox.setActionCommand("Information Quantity");
        InformationQuantityCheckBox.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0, 0, 0));
        InformationQuantityCheckBox.setLabel("Information Quantity");
        InformationQuantityCheckBox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                InformationQuantityCheckBoxActionPerformed(evt);
            }
        });

        InformationQuantityHelpButton.setText("?");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .add(jPanel1Layout.createSequentialGroup()
                ...
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            ...
                            .add(jPanel1Layout.createSequentialGroup()
                                ...
                                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                                    .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                                        ...
                                        .add(org.jdesktop.layout.GroupLayout.LEADING, InformationQuantityHelpButton))
                    ...
                    .add(jPanel1Layout.createSequentialGroup()
                        .add(InformationQuantityCheckBox, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .add(165, 165, 165))))
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .add(jPanel1Layout.createSequentialGroup()
                ...
                .add(18, 18, 18)
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(InformationQuantityHelpButton, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 18, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                    .add(InformationQuantityCheckBox))
                .add(26, 26, 26)
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
        ...
        SingleNetCheckBox.setText("Single networks analysis");
        SingleNetCheckBox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                SingleNetCheckBoxActionPerformed(evt);
            }
        });

        MultipleNetCheckBox.setText("Multiple networks analysis");
        MultipleNetCheckBox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MultipleNetCheckBoxActionPerformed(evt);
            }
        });

        jLabel10.setText("Select multiply attribute:");

        AttributeCombo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        AttributeCombo.addPopupMenuListener(new javax.swing.event.PopupMenuListener() {
            public void popupMenuCanceled(javax.swing.event.PopupMenuEvent evt) {
            }
            public void popupMenuWillBecomeInvisible(javax.swing.event.PopupMenuEvent evt) {
                AttributeComboPopupMenuWillBecomeInvisible(evt);
            }
            public void popupMenuWillBecomeVisible(javax.swing.event.PopupMenuEvent evt) {
                AttributeComboPopupMenuWillBecomeVisible(evt);
            }
        });

        NodeMultButton.setText("Multiply nodes");
        NodeMultButton.setEnabled(false);
        NodeMultButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                NodeMultButtonActionPerformed(evt);
            }
        });
        ...
        RoundButton.setText("Round attribute");
            ...
            .add(jPanel2Layout.createSequentialGroup()
                ...
                .add(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, jPanel2Layout.createSequentialGroup()
                        ...
                        .add(34, 34, 34))
                    .add(jPanel2Layout.createSequentialGroup()
                        .add(SingleNetCheckBox)
                        .add(18, 18, 18)
                        .add(MultipleNetCheckBox)
                        ...
                        .add(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            ...
                            .add(jPanel2Layout.createSequentialGroup()
                                ...
                                .add(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                                    .add(AttributeCombo, 0, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .add(RoundField))
                                .add(18, 18, 18)
                                .add(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                                    .add(NodeMultButton)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .add(org.jdesktop.layout.GroupLayout.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .add(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(jLabel10)
                    .add(AttributeCombo, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                    .add(NodeMultButton))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.UNRELATED)
                .add(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(jLabelServerResponse, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 14, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                    .add(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                        .add(RoundField, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                        .add(RoundButton)))
                .add(5, 5, 5)
                .add(startclient)
                .addContainerGap())
    ...
    private void LoadAttributesButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoadAttributesButtonActionPerformed
        ...
        if (answer == 0) {
            ...
            if (selectednetworkviews.isEmpty()){
                ...
                int i=0;
                for (Iterator it = selectednetworkviews.listIterator(); it.hasNext();) {
                    i=i+1;
                    System.out.println("pas: "+i);
                    currentnetworkview = (CyNetworkView)it.next();
                   ...
                   if (attributesloaded) {
                        changelastworkednetwork(currentnetwork, currentnetworkview);
                        if(MultipleNetCheckBox.isSelected()&& firsttime){
                            centiscapecore.createCentiScaPeMultiNetVisualizer();
                            centiscapecore.getMultiNetVisualizer().setEnabled(VectorResults);
                            firsttime = false;
                        }
                        if(SingleNetCheckBox.isSelected()){
    ...
    public  void loadAttributeList(){
        ...
        AttributeCombo.addItem("None");
        selectednetworkviews = cyApplicationManager.getSelectedNetworkViews();
        for (ListIterator itNet = selectednetworkviews.listIterator(); itNet.hasNext();) {
            currentnetworkview = (CyNetworkView)itNet.next();
            currentnetwork = currentnetworkview.getModel();
            List columns = (List) currentnetwork.getDefaultNodeTable().getColumns();
            for (ListIterator itCol=columns.listIterator();itCol.hasNext();){
                CyColumn col=(CyColumn)itCol.next();
                String colname = col.getName();
                AttributeCombo.addItem(colname);
            }    
        }    
    }
    ...
    private void unselectallButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_unselectallButtonActionPerformed
        ...
        InformationQuantityCheckBox.setSelected(false);
        verifyselection();
    ...
    private void selectallButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_selectallButtonMouseClicked
        ...
        InformationQuantityCheckBox.setSelected(true);
        verifyselection();
        verifynodemultselection();
...
//CytoPanel cytopanelwest = centiscapecore.cyDesktopService.getCytoPanel(CytoPanelName.WEST);
     ...
     //   System.out.println("entro in start");
        ...
        if (selectednetworkviews.isEmpty()) {
            ...
            return;
                ...
                for (ListIterator it = selectednetworkviews.listIterator(); it.hasNext();) {
                    currentnetworkview = (CyNetworkView)it.next();
                    cyApplicationManager.setCurrentNetworkView(currentnetworkview);
                    currentnetwork = currentnetworkview.getModel();
                    ...
                    if (answer == 0) {
                        ...
                        CheckedCentralities[12] = InformationQuantityCheckBox.isSelected();
                        if (undirectedRadioButton.isSelected()) {
                            ...
                            if (secondanswer == 0) {              
                                removeattributes();
                                calculatingresult();
                                ThrEng = new CentiScaPeThreadEngine(CentiScaPealg, currentnetwork);
                                ThrEng.setCaller(this);
                                ThrEng.run();
                                VectorResults = ThrEng.getCentralities();
                                if(NormCentCheckBox.isSelected()){
                                    CentiScaPeNormCent normcent = new CentiScaPeNormCent(VectorResults, currentnetwork);
                                    normcent.calculateNormalizedCentralities();
                                }
                                if(MultipleNetCheckBox.isSelected()&& firsttime){
                                    centiscapecore.createCentiScaPeMultiNetVisualizer();
                                    centiscapecore.getMultiNetVisualizer().setEnabled(VectorResults);
                            ...
                            if (checkIfAlreadyPresentAndDelete()) {
                                ...
                                Thrd.run();
                                VectorResults = Thrd.getCentralities();
                                if(MultipleNetCheckBox.isSelected()&& firsttime){
                                    centiscapecore.createCentiScaPeMultiNetVisualizer();
                                    centiscapecore.getMultiNetVisualizer().setEnabled(VectorResults);
                                    firsttime = false;
 ...
 CentiScaPeHelp help = new CentiScaPeHelp();
    ...
    private void SingleNetCheckBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SingleNetCheckBoxActionPerformed
        // TODO add your handling code here:
        verifyselection();
    }//GEN-LAST:event_SingleNetCheckBoxActionPerformed

    private void MultipleNetCheckBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MultipleNetCheckBoxActionPerformed
        // TODO add your handling code here:
        verifyselection();
    }//GEN-LAST:event_MultipleNetCheckBoxActionPerformed

    private void AttributeComboPopupMenuWillBecomeVisible(javax.swing.event.PopupMenuEvent evt) {//GEN-FIRST:event_AttributeComboPopupMenuWillBecomeVisible
        // TODO add your handling code here:
        loadAttributeList();
    }//GEN-LAST:event_AttributeComboPopupMenuWillBecomeVisible

    private void NodeMultButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NodeMultButtonActionPerformed
        // TODO add your handling code here:
        selectednetworkviews = cyApplicationManager.getSelectedNetworkViews();
        CentiScaPealg = new CentiScaPeAlgorithm(centiscapecore);
        Integer multans;
        if (selectednetworkviews.isEmpty()) {
            ...
            for (ListIterator it = selectednetworkviews.listIterator(); it.hasNext();) {
                ...
                if (currentnetwork.getNodeCount() == 0) {
                    System.out.println("No network1");
                    JOptionPane.showMessageDialog(this.cyDesktopService.getJFrame(),"No network exists!", "CentiScaPe", JOptionPane.WARNING_MESSAGE);
                    return;
                }
                int answer = 0;
                if (iscurrentnetworkchanged()) {
                    ...
                    if (isWeighted) {
                        ...
                        if (undirectedRadioButton.isSelected()) {
                            ...
                            if (secondanswer == 0) {              
                                removeattributes();
                                calculatingresult();
                                CentiScaPeNodeMultiply nodemult = new CentiScaPeNodeMultiply(currentnetwork,(String)AttributeCombo.getSelectedItem(),centiscapecore, "Undirected");
                                multans = nodemult.multiplyNodes();
                                if (multans == JOptionPane.NO_OPTION){
                                    this.jProgressBar1.setIndeterminate(false);
                                    jLabel1.setText("Interrupted by user");
                                    calculating = false;
                                    break;
                                }
                                ThrEng = new CentiScaPeThreadEngine(CentiScaPealg, nodemult.getNetworkChild());
                                ThrEng.setCaller(this);
                                ThrEng.run();
                                VectorResults = ThrEng.getCentralities();
                            ...
                            System.out.println("enter in directed networks\n");
                            if (checkIfAlreadyPresentAndDelete()) {
                                CentiScaPeNodeMultiply nodemult = new CentiScaPeNodeMultiply(currentnetwork,(String)AttributeCombo.getSelectedItem(),centiscapecore, "Directed");
                                multans = nodemult.multiplyNodes();
                                if (multans == JOptionPane.NO_OPTION){
                                    this.jProgressBar1.setIndeterminate(false);
                                    jLabel1.setText("Interrupted by user");
                                ...
                                Thrd = new CentiScaPeDirectedThreadEngine(nodemult.getNetworkChild(), CheckedCentralities, directedCentralities, this, centiscapecore);
                                Thrd.run();
                                VectorResults = Thrd.getCentralities();
                                nodemult.calculateCentralities(VectorResults);
                                this.setEnabled(true);
    ...
    }//GEN-LAST:event_NodeMultButtonActionPerformed

    private void AttributeComboPopupMenuWillBecomeInvisible(javax.swing.event.PopupMenuEvent evt) {//GEN-FIRST:event_AttributeComboPopupMenuWillBecomeInvisible
        // TODO add your handling code here:
        verifynodemultselection();
        verifyroundtselection();
    }//GEN-LAST:event_AttributeComboPopupMenuWillBecomeInvisible
    ...
    private void RoundButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RoundButtonActionPerformed
        ...
        if (selectednetworkviews.isEmpty()) {
            ...
            CentiScaPeNodeMultiply nodemult = new CentiScaPeNodeMultiply(currentnetwork,(String)AttributeCombo.getSelectedItem(),centiscapecore, "Undirected");
            nodemult.attributeRounding(Double.parseDouble(RoundField.getText()));
            this.setEnabled(true);
            }
        }    
    }//GEN-LAST:event_RoundButtonActionPerformed

    private void InformationQuantityCheckBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_InformationQuantityCheckBoxActionPerformed
        // TODO add your handling code here:
    ...
    private javax.swing.JCheckBox NormCentCheckBox;
    ...
    public void verifyselection() {
        if ((DiameterCheckBox.isSelected()
                ...
                || InformationQuantityCheckBox.isSelected())
    ...
    public void verifynodemultselection() {
        if ((DiameterCheckBox.isSelected()
                || AverageDistanceCheckBox.isSelected()
                || DegreeCheckBox.isSelected()
                || EccentricityCheckBox.isSelected()
            ...
            NodeMultButton.setEnabled(true);
        } else {
            NodeMultButton.setEnabled(false);
        }
    }
    
    public void verifyroundtselection() {
        if ((!(AttributeCombo.getSelectedItem().equals("None")))
            &&(!(RoundField.getText().equals("")))) {
